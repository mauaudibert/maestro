...
<div class="row">
	<a href="aluno_lista.php?menu=professor&formulario=1" class="btn btn-default">Adicionar</a>
...
<?php } else { ?>
	<form>
		...
		<label for="E-mail" class="labelform"> <b> E-mail </b>
			...
			class="inputform" /> <input type="submit" /> <label for="unidade"
			class="labelform"> <b> unidade </b>
		</label> <input type="text" name="unidade" id="Nome"
			class="inputform" /> <br /> <label for="disciplina"
			class="labelform"> <b> disciplina </b>
